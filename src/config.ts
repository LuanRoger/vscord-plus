...
export type WorkspaceConfigurationWithType<
  Configuration extends Record<string, any>,
> = {
  /**
   ...
   */
  has<S extends keyof Configuration | (string & Record<never, never>)>(
    section: S,
  ): boolean;
...
export type ExtensionConfiguration =
  WorkspaceConfigurationWithType<ExtensionConfigurationType>;

export const getConfig = () =>
  workspace.getConfiguration("vscord-plus") as ExtensionConfiguration;
